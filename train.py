...
if 1:
    ...
    desc += '-dyh512';     dataset = EasyDict(tfrecord_dir='/root/dyh512');       train.mirror_augment = True
    ...
    desc += '-10gpu'; submit_config.num_gpus = 8; sched.minibatch_base = 32; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32}
