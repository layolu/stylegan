...
def training_loop(
    ...
    resume_run_id           = '/dev/shm/network-snapshot-007900.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7900,      # Assumed training progress at the beginning. Affects reporting and training schedule.
